...
sys.path.append("C:\Users\AIoT05\Desktop\local\project")
...
def run_object_detection(source = 1, flip = False, use_popup = False, skip_first_frames = 0):
   player = None
   try:
...
run_object_detection(source = 0, flip = True, use_popup = True)  # use_popup=False -> jupyter / True -> True
